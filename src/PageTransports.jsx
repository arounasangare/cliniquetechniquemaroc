...
import CirecleTransport from './CirecleTransport';



function PageTransports() {
            ...
            <div className="realcompte">
              ...
              <div className="realcompte pb-5 pt-5 justify-content-center align-items-center">
                ...
                <div className='d-flex align-items-center justify-content-center flex-column'>
                  {/* <TitleSection /> */}
                   <p className="uhfieryfueriug nuhruehnjtrh mb-0">Transport</p>
                  <p className='uhfieryfueriug lrlrlr'> en quelques clics</p> 
                  ...
                  <div className="button nfreuohregdd ngfgureg mt-0">
                    <Link to="/register/client">
                      <button className="giojiojioj ngriugyoeruogyriu">Créer mon compte</button>
                    </Link>
                  </div>
                </Nav.Link>
                </div>
